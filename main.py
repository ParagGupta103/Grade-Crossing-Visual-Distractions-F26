...
def main():
    ...
    if not os.path.exists("coordinates.csv"):
        print(
            "Warning: 'coordinates.csv' not found. 'dataset_generation.py' will likely fail and exit."
        )
        print(
            "Please ensure you have placed your 'coordinates.csv' in the root directory.\n"
        )

    # The order of execution
    scripts = ["dataset_generation.py", "detector.py", "risk_analyzer.py"]
